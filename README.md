# Bricks.Http.RealtimeServer.LongPolling

Пакет реализует сервер с поддержкой long polling.
...
[исходные коды]: https://github.com/Bashka/bricks_http_realtimeserver_longpolling/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_http_realtimeserver_longpolling/issues
